...
func on_input(event: InputEvent) -> void:
	...
	var mouse_at_bottm := card_ui.get_global_mouse_position().y > MOUSE_Y_SNAPBACK_TREHSOLD
	
	if (mouse_motion and mouse_at_bottm) or event.is_action_pressed("right_mouse"):
